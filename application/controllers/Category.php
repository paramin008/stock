...
class Category extends Admin_Controller 
{
	public function __construct()
	{
		...
		$this->data['page_title'] = 'ประเภทสินค้า';
	...
	public function fetchCategoryData()
	{
		...
		foreach ($data as $key => $value) {
			...
			if(in_array('updateCategory', $this->permission)) {
				$buttons .= '<button type="button" class="btn btn-default" onclick="editFunc('.$value['id'].')" data-toggle="modal" data-target="#editModal"><img src="'.base_url(['assets/icon/photo2.png']).'" width="15">
				</button>';
			}
