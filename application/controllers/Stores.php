...
class Stores extends Admin_Controller 
{
	public function __construct()
	{
		...
		$this->data['page_title'] = 'คลังสินค้า';
	...
	public function fetchStoresData()
	{
		...
		foreach ($data as $key => $value) {
			...
			if(in_array('updateStore', $this->permission)) {
				$buttons = '<button type="button" class="btn btn-default" onclick="editFunc('.$value['id'].')" data-toggle="modal" data-target="#editModal"><img src="'.base_url(['assets/icon/photo2.png']).'"  width="15"></button>';
			}
