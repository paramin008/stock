      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">สร้างรายการเบิกสินค้า</h3>
          </div>
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="col-md-4 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_name" name="customer_name" placeholder="ใส่ชื่อผู้เบิก" autocomplete="off" />
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="customer_phone" name="customer_phone" placeholder="ใส่เบอร์โทร" autocomplete="off">
                    </div>
                  </div>
                  
                  <div class="form-group">
                    <label for="gross_amount" class="col-sm-5 control-label" style="text-align:left;">หัวเรื่อง</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="title" name="title" placeholder="ใส่เรื่อง" autocomplete="off">
                    </div>
                  </div>
                </div>
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('orders/') ?>" class="btn btn-warning">กลับ</a>
              </div>
            </form>
          <!-- /.box-body -->
        </div>
