    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createBrand', $user_permission)): ?>
          <button class="btn btn-primary" data-toggle="modal" data-target="#addBrandModal">เพิ่มแบรนด์สินค้า</button>
          <br /> <br />
        <?php endif; ?>

        <div class="box">
          <div class="box-header">
            <h3 class="box-title">รายการแบรนด์สินค้า</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
