  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <li><a href="<?php echo base_url('dashboard') ?>"> <img src="<?php echo base_url('assets/icon/dashboard.png') ?>"width="25px">  หน้าแรก</a></li>
        <li><a href="<?php echo base_url('groups/') ?>">กลุ่มผู้ใช้</a></li>
        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">แก้ไขกลุ่มผู้ใช้</h3>
            </div>
            <form role="form" action="<?php base_url('groups/update') ?>" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="group_name" name="group_name" placeholder="ใส่ชื่อกลุ่ม" value="<?php echo $group_data['group_name']; ?>">
                </div>
                <div class="form-group">
